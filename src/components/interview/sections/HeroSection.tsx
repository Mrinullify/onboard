        ...
        <Card className="border-none bg-linear-to-br from-pink-100 via-white to-blue-200 shadow-none bg-transparent">
            <CardContent className="p-5 space-y-4">
                ...
                <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">
                    Build Your AI Interview
                </h1>

                {/* Description */}
                <p className="text-muted-foreground max-w-2xl leading-relaxed">
                    Customize your interview experience by selecting role, difficulty,
                    topics, and format. Our AI will simulate real-world interview scenarios
